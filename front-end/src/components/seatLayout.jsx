  ...
  return (
    <div className="dynamic-seat-layout bg-[#1a1a1a] text-[#cec3c8] min-h-screen p-6">
      ...
      <div className="config-form bg-[#2d2d2d] p-6 rounded-lg shadow-md mb-8">
        ...
        <div>Note:if u want to give space between name it null,if the whole space between rows let the seats:null</div>
        {rows.map((row, index) => (
          <div
            key={index}
      ...
      <div className="mt-6">
        <p className="text-lg font-semibold">Total Seats: {totalSeats}</p>
      </div>
